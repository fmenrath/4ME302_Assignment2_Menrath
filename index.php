...
//Safety measure: Automatic logout from all providers if user is still logged in while on the index.php page
//This can happen when the user uses the browsers "back" button instead of the webapps logout-button, for example.
...
<body>
    <div class="head-text">
        <p class="h1" style="margin-top: 30px;">4ME302: Assignment 2</hp>
